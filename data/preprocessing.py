...
def gan_common_crop(*args, patch_size=96):
    '''
    Crop given patches.
...
def np_crop(*args, patch_size=96):
    '''
    Crop given patches.
...
def wavelet_crop(img_gt, img, img_lr, scale=2, patch_size=96):
    '''
    Crop given patches.
...
def gan_augment(*args, hflip=True, vflip=True, rot=False, ):
    """
        Apply random augmentations to given patches.
        Args:
        Return:
