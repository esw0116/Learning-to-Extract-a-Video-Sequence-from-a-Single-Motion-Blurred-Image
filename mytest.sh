...
# python test.py --dataset reds --output_path quantitative/jin_REDS --seq_len 5 --cuda --save_img
# python test.py --dataset reds --output_path quantitative/jin_REDS --seq_len 7 --cuda 
...
# python test.py --dataset reds --deblur models/mprnet.pth --output_path quantitative/mprnet_REDS --seq_len 5 --cuda --save_img
# python test.py --dataset reds --deblur models/mprnet.pth --output_path quantitative/mprnet_REDS --seq_len 7 --cuda 
